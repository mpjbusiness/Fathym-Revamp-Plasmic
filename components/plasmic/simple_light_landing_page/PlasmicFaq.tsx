...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: m_bBKXqy__Jt/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xrQtB)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__sFwzm)}>
          <div className={classNames(projectcss.all, sty.freeBox__kbLc0)}>
            {p.renderPlasmicSlot({
